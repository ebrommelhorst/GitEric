...
int main()
{
	...
	if(obj1 > obj2)	// normal expression. Which operator is being called? greater than
	...
	if(obj2 > obj1)	// Which operator is being called? greater than
	...
	obj1 + obj2;	// normal expression. Which operator is being called? addition
	// obj1.operator+(obj2);	// equivalent, try it out
	obj1.Printvals();
	obj2.Printvals();
	
	obj2 + obj1;	// normal expression. Which operator is being called? addition
	...
	obj3 = operator+(obj1, obj2);	// Would  obj3 = obj2 + obj1; work? Yes
